package com.droveda.customerportfolio;
...
class CustomerServiceApplicationTests {
    ...
    public void insufficientShares() {
        //sqll
        var selRequest1 = new StockTradeRequest(Ticker.GOOGLE, 100, 1, TradeAction.SELL);
        trade(3, selRequest1, HttpStatus.BAD_REQUEST)
    ...
    private WebTestClient.BodyContentSpec getCustomer(Integer customerId, HttpStatus expectedStatus) {
        return this.client.get()
                ...
                .expectBody().consumeWith(e -> log.info("{}", new String(Objects.requireNonNull(e.getResponseBody()))));
    }
