package com.droveda.customerportfolio.advice;

import com.droveda.customerportfolio.exceptions.CustomerNotFoundException;
import com.droveda.customerportfolio.exceptions.InsufficientBalanceException;
import com.droveda.customerportfolio.exceptions.InsufficientSharesException;
...
public class ApplicationExceptionHandler {
    ...
    public ProblemDetail handleException(InsufficientBalanceException ex) {
        return build(HttpStatus.BAD_REQUEST, ex, problem -> {
            problem.setType(URI.create("http://example.com/problems/unsifficient-balance"));
    ...
    public ProblemDetail handleException(InsufficientSharesException ex) {
        return build(HttpStatus.BAD_REQUEST, ex, problem -> {
            problem.setType(URI.create("http://example.com/problems/unsifficient-shares"));
