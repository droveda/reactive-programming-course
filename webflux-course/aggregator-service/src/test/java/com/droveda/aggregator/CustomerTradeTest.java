package com.droveda.aggregator;
...
public class CustomerTradeTest extends AbstractIntegrationTest {
    ...
    void tradeSuccess() {
        ...
        var tradeRequest = new TradeRequest(Ticker.GOOGLE,
                TradeAction.BUY,
                2);
    ...
    void inputValidation() {
        ...
        var invalidQuantity = new TradeRequest(Ticker.GOOGLE,
                TradeAction.BUY,
                -2);
    ...
    private void mockCustomerTrade(String path, int responseCode) {
        //given - mock stock-service price response
        ...
        //given - mock customer-service trade response
