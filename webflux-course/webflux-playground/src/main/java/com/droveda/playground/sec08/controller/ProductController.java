package com.droveda.playground.sec08.controller;

import com.droveda.playground.sec08.dto.ProductDto;
import com.droveda.playground.sec08.dto.UploadResponse;
import com.droveda.playground.sec08.service.ProductService;
...
public class ProductController {
    ...
    public Mono<UploadResponse> uploadProducts(@RequestBody Flux<ProductDto> flux) {
        ...
        return this.service
//                .saveProduct(flux.doOnNext(dto -> log.info("received: {}", dto)))
                .saveProduct(flux)
